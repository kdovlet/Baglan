...
from Baglan.forms import RegisterForm, ProfileForm, PostForm
	...
	def dispatch(self, request, *args, **kwargs):
		...
		if request.method == 'POST':
			...
			if form.is_valid():
				...
				messages.success(request, 'Siz registrasiýa edildiňiz, indi girip bilersiňiz')
				return redirect('/')
		context = {
			'form': form
		}
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                form.save()
                messages.success(request, "Profil tazelendi")
